...
中位数指的是将一组数据按照从小到大的顺序排列，取中间的一个数（若数据个数为偶数，则取中间两个数的平均值）。中位数对于极端值的影响不敏感，因此更能反映数据的典型值。在 2022 年，全国居民人均可支配收入的中位数是 31370 元，这意味着超过一半的居民的可支配收入低于这个水平。

平均数则是指数据集中所有数值的总和除以数据的个数。平均数能够反映出数据集的总体水平，但在数据存在极端值的情况下，平均数容易被极端值所影响。在 2022 年，全国居民人均可支配收入的平均数为 36883 元。

举例来说，假设现在有五个人，他们的收入分别是 1、2、2、2、11 元。那么这五个人的平均收入是 3.6 元，中位数是 2 元。如果你的收入达到中位数水平，那么你就已经超过了一半的人。如果你的收入达到平均数水平，你就已经超过了大多数人的收入水平。
...
2022 年全国居民人均可支配收入为 36883 元，而 2021 年的数据约为 35128.1 元，差不多。假设你和你的爱人的收入都是税后 3.5 万元，那么你们的总收入为 7 万元。如果你们有一个在上学的孩子，那么你们的家庭人均可支配收入为 7/3=2.34 万元。如果你们家中还有年迈的父母需要赡养，并且没有其他收入来源，那么你们的家庭人均可支配收入将更低。这样的收入水平可以被认为是中等偏下，甚至是低收入组家庭。
